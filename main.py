...
class Text_Editor(QMainWindow):
    ...
    def create_toolbar(self):
        ...
        tool_bar = QToolBar()
        undo_action = QAction(QIcon("undo.png"), "Desfazer", self)
        undo_action.triggered.connect(self.editor.undo)
        tool_bar.addAction(undo_action)
        self.addToolBar(tool_bar)

        redo_action = QAction(QIcon("redo.png"), "Refazer", self)
        ...
        paste_action = QAction(QIcon("paste.png"), "Colar", self)
        ...
        bold_action = QAction(QIcon("bold.png"), 'Negrito', self)
        bold_action.triggered.connect(self.bold_text)
        tool_bar.addAction(bold_action)

        underline_action = QAction(QIcon("underline.png"), 'Sublinhado', self)
        underline_action.triggered.connect(self.underline_text)
        tool_bar.addAction(underline_action)

        italic_action = QAction(QIcon("italic.png"), 'Italico', self)
